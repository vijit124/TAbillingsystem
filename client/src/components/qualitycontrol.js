...
class QualityControl extends Component {
    ...
    constructor() {
        ...
        axios.post($links.qualitydashboard, displaytype)
            .then(res => {
                if (res.data.auth) {
                    ...
                    <Grid item xs={12} sm={12}>
                        <MaterialTable style={{ borderRadius: 15, borderBottom: '3px solid #f0bc11', borderTop: '3px solid #4cc42d', boxShadow: '0 8px 16px 0 rgba(0,0,0,0.4)' }}
                            ...
                            columns={[
                                ...
                                { title: 'Last Updated', field: 'updated', headerStyle: nowrap, cellStyle: { width: '15%', whiteSpace: 'nowrap' } },
                                { title: 'Status', field: 'status', headerStyle: nowrap, cellStyle: nowrap, hidden: true, lookup: { 1: 'Quality Control', 2: 'Delivered' } },
